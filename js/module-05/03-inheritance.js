...
class Warrior extends Hero {//this ,из суппер конструктора херо, наследуемого класса
...
console.log(Warrior.prototype.__proto__ === Hero.prototype); //динамическая диспетчеризация
